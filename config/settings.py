...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", "OfficeFlow <noreply@officeflow.local>")
...
OFFICEFLOW_PWA_CACHE_VERSION = env("OFFICEFLOW_PWA_CACHE_VERSION", "v1")
